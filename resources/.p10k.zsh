# Generated by Powerlevel10k configuration wizard on 2025-01-16 at 21:13 CET.
...
() {
  ...
  #typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='k|kn|kc|kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubent|kubecolor|cmctl|sparkctl'
